package com.bonvio.project2.classes.cafe.events.serializers;
 ...
 */
public class MenuPositionWithQuantitySerializer extends JsonSerializer<MenuPositionWithQuantity> {
    @Override
    public void serialize(MenuPositionWithQuantity i, JsonGenerator g, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
        g.writeStartObject();
        ...
        g.writeNumberField("positionQuantityInOrder", i.getPositionQuantityInOrder());
