...
<!-- Message Page -->
<div data-role="page" data-add-back-btn="false" data-back-btn-text="Назад" id="message_page" data-theme="a">
    <div data-role="header" data-position="fixed">
        <h1>Lib Waiters - Лист сообщений</h1>
        <a href="#demo-intro" data-rel="back" data-icon="carat-l" data-iconpos="notext">Back</a>
        <a href="#nav-panel" data-icon="bars" data-iconpos="notext">Menu</a>
    </div>
    <div data-role="content" >
        <ul class="message_ulEventList" data-role="listview" data-theme="a" data-dividertheme="b" data-filter="true" data-filter-theme="a" data-filter-placeholder="Поиск...">
            <!-- NONE -->
        </ul>
    </div>
