...
function widthFunctions(e) {
    var t = $(".navbar").outerHeight(),
        ...
        r = $(window).height(),
        i = $(window).width();
    $("body").hasClass("static-sidebar") || $(".sidebar-menu").css("height", r - 200);
    if (i < 992) {
        $("body").removeClass("sidebar-minified");
        $("#sidebar-minify i").removeClass("fa-list").addClass("fa-ellipsis-v")
    }
    i > 768 && $(".mainmain").css("min-height", r - n)
}
$.ajaxLoad = !0;
...
if ($.ajaxLoad) {
    ...
    $(document).on("click", '.nav a[href!="#"]', function(e) {
        if ($(this).parent().parent().hasClass("nav-tabs") || $(this).parent().parent().hasClass("nav-pils")) e.preventDefault();
...
$(document).ready(function(e) {
    ...
    e(".indicator").each(function() {
        e(this).addClass(e.mainMenuIndicatorClosed)
    });
