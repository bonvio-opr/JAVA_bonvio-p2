...
(function (window, $, undefined) {
	...
	$.Song.prototype = {
		...
		_init: function () {
			...
			this.sources = {
				mp3: '/CM/resources/workspace/audio/songs/' + this.name + '.mp3',
				ogg: '/CM/resources/workspace/audio/songs/' + this.name + '.ogg'
			};
	...
	$.Sound.prototype = {
		...
		getSource: function (type) {
			...
			return '/CM/resources/workspace/audio/sounds/' + this.action + '.' + type;
